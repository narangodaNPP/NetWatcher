...
class Services extends Component {
    ...
    fetchServices() {
        ...
        let requestUrl = process.env.REACT_APP_NPA_HOST + '/services'
        fetch(requestUrl)
            .then(res => res.json())
            .then((data) => {
    ...
    initiateTraceRoute( target ) {
        ...
        let requestUrl = process.env.REACT_APP_NPA_HOST + '/traceroute?target=' + target
    ...
    fetchTraceRouteResults( target ) {
        ...
        let requestUrl = process.env.REACT_APP_NPA_HOST + '/traceroute?target=' + target + '&token=' + this.state.token
