...
from server_utils import get_hostname_from_target, get_ip_address_from_target
from db_hourly_tasks import DbHourlyTask
...
NetWatcher = Flask(__name__)
CORS(NetWatcher)

api = Api(NetWatcher, version="1.0", title="NetWatcher")
